...
export async function iniciarCercania()
{
  ...
  if (!permiso.ok)
  {
    const lista = (permiso.negados || []).join(" y ") || "Bluetooth/ubicación";
    return { ok: false, razon: `Falta el permiso de ${lista}. Actívalo en los ajustes de la app.`, abrirAjustes: true };
  }
