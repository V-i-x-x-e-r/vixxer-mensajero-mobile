...
export function envolverAviso(segundos)
{
  return JSON.stringify({ t: "tmpaviso", d: segundos });
}
...
export function leerAviso(texto)
{
  ...
  try
  {
    ...
    return obj && obj.t === "tmpaviso" ? obj : null;
  }
  catch (e)
  {
    return null;
...
export function textoAviso(segundos)
{
  return segundos > 0
    ? `Mensajes temporales activados · ${etiquetaDuracion(segundos)}`
